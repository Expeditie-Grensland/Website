...
declare module "mongoose" {
    ...
    class CastError extends Error {
         ...
         */
        constructor(type: string, value: any, path: string, reason?);
    }
    ...
    class Schema extends events.EventEmitter {
        ...
        post<T extends Document>(method: string, fn: (doc: T, next: (err?) => void,
            ...otherArgs: any[]) => void): this;

        /**
         * Defines a pre hook for the document.
         */
        pre(method: string, fn: (next: (err?) => void) => void,
            errorCb?: (err: Error) => void): this;
        pre(method: string, parallel: boolean, fn: (next: (err?) => void, done: () => void) => void,
            errorCb?: (err: Error) => void): this;
    ...
    class MongooseDocument implements MongooseDocumentOptionals {
         ...
         */
        invalidate(path: string, errorMsg, value: any, kind?: string): ValidationError | boolean;
    ...
    namespace Types {
        ...
        class Buffer {
             ...
             */
            copy(target, ...nodeBufferArgs: any[]): number;
    ...
    namespace Schema {
        namespace Types {
            ...
            class Date extends SchemaType {
                 ...
                 * @param message optional custom error message
                 */
                max(maximum, message?: string): this;
